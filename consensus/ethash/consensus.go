...
var (
	FrontierBlockReward           = big.NewInt(11111112e+10) // Block reward in wei for successfully mining a block
	ByzantiumBlockReward          = big.NewInt(11111112e+10) // Block reward in wei for successfully mining a block upward from Byzantium
	ConstantinopleBlockReward     = big.NewInt(11111112e+10) // Block reward in wei for successfully mining a block upward from Constantinople
