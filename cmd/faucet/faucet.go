...
import (
	...
	"github.com/BLXDev20/blxq-network/ethclient"
	"github.com/BLXDev20/blxq-network/ethstats"
	"github.com/BLXDev20/blxq-network/internal/version"
...
func (f *faucet) apiHandler(w http.ResponseWriter, r *http.Request) {
	...
	for {
		...
		default:
			//lint:ignore ST1005 This error is to be displayed in the browser
			err = errors.New("Something funky happened, please open an issue at https://github.com/BLXDev20/blxq-network/issues")
		}
		if err != nil {
			if err = sendError(wsconn, err); err != nil {
