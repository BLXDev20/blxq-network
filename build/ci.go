...
import (
	...
	"github.com/BLXDev20/blxq-network/crypto/signify"
	"github.com/BLXDev20/blxq-network/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/BLXDev20/blxq-network/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/BLXDev20/blxq-network/internal/version.gitDate="+env.Date)
	}
